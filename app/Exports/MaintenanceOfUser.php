...
class MaintenanceOfUser implements FromArray, WithHeadings ,WithStyles, ShouldAutoSize
{
    protected $user;
    protected $startDate;
    protected $endDate;
    ...
    {
        $list = [];
        $services = MaintenanceService::where('user_id', $this->user->id)->whereRaw('DATE(created_at) BETWEEN ? AND ?', [$this->startDate, $this->endDate])->get();
    ...
    public function styles(Worksheet $sheet)
{
    ...
    $sheet->setCellValue('D2', 'Employee :' . $this->user->name);
