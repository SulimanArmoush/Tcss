...
class InstallationOfDepartment implements FromArray, ShouldAutoSize, WithHeadings, WithStyles
{
    ...
    {
        return ['id', 'date','device', 'Employee', 'discription','code', 'materials', 'quantity'];
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('E2', 'Department :' . $this->department->name);
